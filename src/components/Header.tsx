                        ...
                        {user.photo ? (
                          <img 
                            ...
                            onError={(e) => { 
                              ...
                              if (parent) {
                                parent.innerHTML = `<span class="w-full h-full flex items-center justify-center text-white font-bold text-lg">${user?.nom?.charAt(0)?.toUpperCase()}</span>`;
                              }
                            }} 
                          />
                        ) : (
                            ...
                            {user.photo ? (
                              <img 
                                ...
                                onError={(e) => { 
                                  ...
                                  const parent = target.parentElement;
                                  if (parent) {
                                    parent.innerHTML = `<span class="w-full h-full flex items-center justify-center text-white text-sm font-semibold">${user?.nom?.charAt(0)?.toUpperCase()}</span>`;
                                  }
                                }} 
                              />
                            ) : (
